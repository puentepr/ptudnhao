...
namespace BIZ
{
    public partial class DoanhThuLoaiSPTheoDonHangCoupon : System.Web.UI.Page
    {
        ...
        protected void btThongKe_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("DoanhThuLoaiSPTheoDonHangCoupon.aspx?Day1=" + day1.ToString("MM/dd/yyyy") + "&Day2=" + day2.ToString("MM/dd/yyyy"));
        }
