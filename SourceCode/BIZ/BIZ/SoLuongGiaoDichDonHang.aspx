<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoLuongGiaoDichDonHang.aspx.cs" Inherits="BIZ.SoLuongGiaoDichDonHang1" %>
...
<head runat="server">
    <title>Thống kê số lượng giao dịch theo đơn hàng</title>
     <style type="text/css">
        .style1
        {
            width: 100%;
...
<body>
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="SoLuongGiaoDichDonHang.rpt">
            <DataSources>
                <CR:DataSourceRef DataSourceID="SqlDataSource1" TableName="DONHANG" />
            </DataSources>
            <Parameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [DONHANG] WHERE (([NGAYDAT] &gt;= @NGAYDAT) AND ([NGAYDAT] &lt;= @NGAYDAT2))">
        <SelectParameters>
