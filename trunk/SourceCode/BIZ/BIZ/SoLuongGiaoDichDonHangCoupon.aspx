<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoLuongGiaoDichDonHangCoupon.aspx.cs" Inherits="BIZ.SoLuongGiaoDichDonHangCoupon1" %>
...
<head runat="server">
    <title>Thống kê số lượng giao dịch theo đơn hàng coupon</title>
...
<table class="style1">
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="SoLuongGiaoDichDonHangCoupon.rpt">
            <DataSources>
                <CR:DataSourceRef DataSourceID="SqlDataSource1" TableName="DONHANGCOUPON" />
            </DataSources>
            <Parameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [DONHANGCOUPON] WHERE (([NGAYDAT] &gt;= @NGAYDAT) AND ([NGAYDAT] &lt;= @NGAYDAT2))">
        <SelectParameters>
