...
namespace BIZ
{
    public partial class DoanhThuLoaiSPTheoDonHang : System.Web.UI.Page
    {
        ...
        {            
            ...
            Response.Redirect("DoanhThuLoaiSPTheoDonHang.aspx?Day1=" + day1.ToString("MM/dd/yyyy") + "&Day2=" + day2.ToString("MM/dd/yyyy"));
        }
