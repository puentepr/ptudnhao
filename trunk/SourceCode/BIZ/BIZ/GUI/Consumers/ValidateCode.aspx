<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="ValidateCode.aspx.cs" Inherits="BIZ.GUI.Consumers.ValidateCode" %>
...
<%@ Register src="../UserControls/ValidateOrder.ascx" tagname="ValidateOrder" tagprefix="uc9" %>
...
<div class="first-secondary">
    ...
    <div class="primary">
        ...
        <uc9:ValidateOrder ID="ValidateOrder1" runat="server" />
