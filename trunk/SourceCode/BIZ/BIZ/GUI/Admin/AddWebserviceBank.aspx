<%@ Page Language="C#" MasterPageFile="~/GUI/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddWebserviceBank.aspx.cs" Inherits="BIZ.GUI.Admin.AddWebserviceBank" Title="Untitled Page" %>
...
<%@ Register src="../UserControls/AddServiceBank.ascx" tagname="AddServiceBank" tagprefix="uc6" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
Thêm web service ngân hàng</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="primary">                   
        ...
        <uc6:AddServiceBank ID="AddServiceBank1" runat="server" />
