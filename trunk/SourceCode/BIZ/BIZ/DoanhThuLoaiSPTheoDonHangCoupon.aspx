<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoanhThuLoaiSPTheoDonHangCoupon.aspx.cs" Inherits="BIZ.DoanhThuLoaiSPTheoDonHangCoupon" %>
...
<head runat="server">
    <title>Thống kê doanh thu loại sản phẩm theo đơn hàng coupon</title>
     <style type="text/css">
        .style1
        {
            width: 100%;
...
<body>
    ...
    <table class="style1">
            <tr>
                <td class="style2">
                    Từ ngày:
                    <asp:TextBox ID="txtTuNgay" CssClass="textbox" runat="server"></asp:TextBox>
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="DoanhThuLoaiSPThroDonHangCouponcr.rpt">
            <DataSources>
                <CR:DataSourceRef DataSourceID="SqlDataSource1" 
                    TableName="V_DoanhThuLoaiSPTheoDHCP" />
            </DataSources>
            <Parameters>
                <CR:ControlParameter ControlID="txtTuNgay" ConvertEmptyStringToNull="False" 
                    DefaultValue="" Name="TuNgay" PropertyName="Text" ReportName="" />
                <CR:ControlParameter ControlID="txtDenNgay" ConvertEmptyStringToNull="False" 
                    DefaultValue="" Name="DenNgay" PropertyName="Text" ReportName="" />
            </Parameters>
        </Report>
    </CR:CrystalReportSource>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        SelectCommand="SELECT * FROM [V_DoanhThuLoaiSPTheoDHCP] WHERE (([NGAYDAT] &gt;= @NGAYDAT) AND ([NGAYDAT] &lt;= @NGAYDAT2))">
        <SelectParameters>
